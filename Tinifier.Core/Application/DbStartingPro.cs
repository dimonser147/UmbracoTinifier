...
{
    public class DbStartingPro : ApplicationEventHandler
    {
        /// <summary>
        ...
        protected override void ApplicationStarted(UmbracoApplicationBase umbracoApplication, ApplicationContext applicationContext)
        {
            ...
            {
                { ProPackageConstants.MediaHistoryTable, typeof(TinifierMediaHistory) }
            };
            ...
            //migrations
            foreach (var migration in Migrations.ProMigrationHelper.GetAllMigrations())
            {
